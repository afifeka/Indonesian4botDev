...
bot.on('message', async message => {
    ...
    if (msg === prefix + 'UPDATE') {
        message.channel.send('**PENGEMBANGAN/PERBAIKAN/UPDATE-NOW-TOPIC** \n\n- Memperbaharui 8 alts Minecraft, terdiri dari Alts SFA dan NFA! \n- Cooldown system 3sec. \n- Baru! command unmute DAN mute !!!');
    }
    ...
    // ALTS
    var alts = ["martinl94@hotmail.no:Vetikke1", "kazu_1214_sa@yahoo.co.jp:Kh94061214", "ang050608@gmail.com:tristen7", "echo28lp@gmail.com:Mandarinka123", "obsercraftporter@gmail.com:Popi2012", "121212gamer@gmail.com:22rem8cool", "kenoxptgames@gmail.com:Chinoca1", "jonas.diasleite@gmail.com:yota1234", "kellihermesch@gmail.com:kc220bt428", "xkuba.hrdlicka@gmail.com:kh4581832", "kazu_1214_sa@yahoo.co.jp:Kh94061214", "ccdragon30@gmail.com:12redfish", "01uscs@yahoo.com:hellfire", "02.melanie@web.de:Maus2000", "raymondcastaneda79@gmail.com:polo12polo", "sallyariad@gmail.com:ps3man007", "rickard4466@gmail.com:bravo2000"]
    var throwAlt = alts[Math.floor(Math.random() * alts.length)];

    if (msg.startsWith(prefix + 'ALTS')) {
        message.react("✅")
        message.reply('**AKTIFKAN SISTEM IZIN MEMBER DIRECT MESSAGES!**')
        await message.author.send(`**SELAMAT! ANDA MENDAPATKAN ALTS MINECRAFT RANDOM!** \n \n**SUDAH MENDAPATKAN IZIN DARI StevenHD_#6344** \n\n${throwAlt}`);
    }
    ...
    if (msg.startsWith(prefix + 'PLAY')) {
        ...
        if (!voiceChannel) {
            return message.channel.send(":x: Masuk ke salah satu channel terlebih dahulu!");
        }
        voiceChannel.join()
        .then(connection => {
        const args = message.content.split(" ").slice(1);
            ...
            message.channel.send(`Dimainkan sekarang: \`${title}\``)
            })
